...
if exist c:\work\emsdk\emscripten\1.38.8\em++.bat (
    del out\voymod.wasm
    del out\voymod.js
) else (
    md out
...
if exist c:\work\emsdk\emscripten\1.38.8\em++.bat (
    REM c:\work\emsdk\emscripten\1.38.8\em++.bat ..\native\VoyageCalculator.cpp main.cpp -o out\voymod.js --bind -O3 -std=c++1y -s DISABLE_EXCEPTION_CATCHING=0 -s NO_EXIT_RUNTIME=1 -s WASM=1 -s ALLOW_MEMORY_GROWTH=1 -s MODULARIZE=1 -s EXPORT_NAME="VoyMod" -I "." -I "..\native"
    REM For debug builds:
    c:\work\emsdk\emscripten\1.38.8\em++.bat ..\native\VoyageCalculator.cpp main.cpp -o out\voymod.js --bind -O1  -std=c++1y -s ASSERTIONS=1 -s DISABLE_EXCEPTION_CATCHING=0 -s NO_EXIT_RUNTIME=1 -s WASM=1 -s ALLOW_MEMORY_GROWTH=1 -s MODULARIZE=1 -s EXPORT_NAME="VoyMod" -I "." -I "..\native"
) else (
